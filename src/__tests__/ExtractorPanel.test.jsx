...
describe('ExtractorPanel', () => {
  ...
  it('renders with default limit of 100', () => {
    ...
    const input = screen.getByLabelText(/Number of Posts/i);
  ...
  it('calls onStart with limit when start button clicked', () => {
    ...
    const startButton = screen.getByText(/Start Extraction/i);
  ...
  it('shows stop button when extracting', () => {
    ...
    expect(screen.queryByText(/Start Extraction/i)).not.toBeInTheDocument();
  });
